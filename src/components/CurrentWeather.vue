          ...
          <div class="weather-info">
            ...
            <div class="high-low-temperatures">
                <div class="high">
                    ...
                    <span>{{Math.round(this.currentWeather.main.temp_max)}}</span>
                </div>
                <div class="low">
                    <i class="fas fa-chevron-down"></i>
                    <span>{{Math.round(this.currentWeather.main.temp_min)}}</span>
                </div>
            </div>
            <span class="condition">{{this.currentWeather.weather[0].description}}</span>
            <span class="feels-like">Feels like {{Math.round(this.currentWeather.main.feels_like)}}&deg;C</span>
          </div>
